# `@osjwnpm/numquam-voluptas-quisquam` <sup>[![Version Badge][npm-version-svg]][package-url]</sup>
...
```sh
npm install eslint @osjwnpm/numquam-voluptas-quisquam --save-dev
```
...
If you are using the [new JSX transform from React 17](https://reactjs.org/blog/2020/09/22/introducing-the-new-jsx-transform.html#removing-unused-react-imports), extend [`react/jsx-runtime`](https://github.com/osjwnpm/numquam-voluptas-quisquam/blob/c8917b0885094b5e4cc2a6f613f7fb6f16fe932e/index.js#L163-L176) in your eslint config (add `"plugin:react/jsx-runtime"` to `"extends"`) to disable the relevant rules.
...
**Note**: These configurations will import `@osjwnpm/numquam-voluptas-quisquam` and enable JSX in [parser options](https://eslint.org/docs/user-guide/configuring/language-options#specifying-parser-options).
...
The default export of `@osjwnpm/numquam-voluptas-quisquam` is a plugin object.

```js
const react = require('@osjwnpm/numquam-voluptas-quisquam');
...
- `@osjwnpm/numquam-voluptas-quisquam/configs/all`
- `@osjwnpm/numquam-voluptas-quisquam/configs/recommended`
- `@osjwnpm/numquam-voluptas-quisquam/configs/jsx-runtime`

If your eslint.config.js is ESM, include the `.js` extension (e.g. `@osjwnpm/numquam-voluptas-quisquam/recommended.js`). Note that the next semver-major will require omitting the extension for these imports.

**Note**: These configurations will import `@osjwnpm/numquam-voluptas-quisquam` and enable JSX in [`languageOptions.parserOptions`](https://eslint.org/docs/latest/user-guide/configuring/configuration-files-new#configuration-objects).
...
```js
const reactRecommended = require('@osjwnpm/numquam-voluptas-quisquam/configs/recommended');
...
💼 [Configurations](https://github.com/osjwnpm/numquam-voluptas-quisquam/#shareable-configs) enabled in.\
🚫 [Configurations](https://github.com/osjwnpm/numquam-voluptas-quisquam/#shareable-configs) disabled in.\
🏃 Set in the `jsx-runtime` [configuration](https://github.com/osjwnpm/numquam-voluptas-quisquam/#shareable-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/osjwnpm/numquam-voluptas-quisquam/#shareable-configs).\
...
- Rules of Hooks: [@osjwnpm/numquam-voluptas-quisquam-hooks](https://github.com/facebook/react/tree/master/packages/@osjwnpm/numquam-voluptas-quisquam-hooks)
- JSX accessibility: [eslint-plugin-jsx-a11y](https://github.com/jsx-eslint/eslint-plugin-jsx-a11y)
- React Native: [@osjwnpm/numquam-voluptas-quisquam-native](https://github.com/Intellicode/@osjwnpm/numquam-voluptas-quisquam-native)

## License

`@osjwnpm/numquam-voluptas-quisquam` is licensed under the [MIT License](https://opensource.org/licenses/mit-license.php).

[npm-url]: https://npmjs.org/package/@osjwnpm/numquam-voluptas-quisquam
[npm-image]: https://img.shields.io/npm/v/@osjwnpm/numquam-voluptas-quisquam.svg

[status-url]: https://github.com/osjwnpm/numquam-voluptas-quisquam/pulse
[status-image]: https://img.shields.io/github/last-commit/jsx-eslint/@osjwnpm/numquam-voluptas-quisquam.svg

[tidelift-url]: https://tidelift.com/subscription/pkg/npm-@osjwnpm/numquam-voluptas-quisquam?utm_source=npm-@osjwnpm/numquam-voluptas-quisquam&utm_medium=referral&utm_campaign=readme
[tidelift-image]: https://tidelift.com/badges/package/npm/@osjwnpm/numquam-voluptas-quisquam?style=flat

[package-url]: https://npmjs.org/package/@osjwnpm/numquam-voluptas-quisquam
[npm-version-svg]: https://versionbadg.es/jsx-eslint/@osjwnpm/numquam-voluptas-quisquam.svg

[actions-image]: https://img.shields.io/endpoint?url=https://github-actions-badge-u3jn4tfpocch.runkit.sh/jsx-eslint/@osjwnpm/numquam-voluptas-quisquam
[actions-url]: https://github.com/osjwnpm/numquam-voluptas-quisquam/actions
